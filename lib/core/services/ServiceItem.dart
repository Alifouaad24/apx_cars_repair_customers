...
Future<Uint8List> generateInvoicePdf(ReciptData data) async {
...
pw.Widget _buildHeader(ReciptData data) {
  return pw.Row(
    crossAxisAlignment: pw.CrossAxisAlignment.start,
...
pw.Widget _buildCustomerBox(ReciptData data) {
  return pw.Container(
    decoration: pw.BoxDecoration(
...
pw.Widget _buildVehicleBox(ReciptData data) {
...
pw.Widget _buildServicesTable(ReciptData data) {
...
pw.Widget _buildTechnicianNotes(ReciptData data) {
  return pw.Column(
    crossAxisAlignment: pw.CrossAxisAlignment.start,
    children: [
      pw.Text(
...
pw.Widget _buildTotalsBox(ReciptData data) {
...
Future<bool> sendInvoiceEmail({
  ...
  required ReciptData invoiceData,
}) async {
