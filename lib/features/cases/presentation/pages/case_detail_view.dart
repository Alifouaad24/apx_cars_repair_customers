...
//         final List<OrderImage> carImages = controller.currentCase?.orderImages ?? const [];
//         final bool hasImages = carImages.isNotEmpty;
//         final bool hasServices =
//             (currentCase.oredesServices ?? const []).isNotEmpty;
...
//                                 ),
//                                 child: Text(
//                                   '${currentCase.oredesServices?.length ?? 0}',
//                                   style: TextStyle(
//                                     color: primary,
//                                     fontWeight: FontWeight.bold,
//                                     fontSize: 13,
...
//                             padding: const EdgeInsets.symmetric(horizontal: 16),
//                             itemCount: currentCase.oredesServices!.length,
//                             itemBuilder: (context, index) {
//                               final OrderServiceModel orderService =
//                                   currentCase.oredesServices![index];
//                               return ServiceCard(service: orderService);
//                             },
//                           ),
...
//                               foregroundColor: Color(0xFF155E75),
...
// // ═══════════════════════════════════════════════════════════════════════
// void showAddServiceDialog(CaseController controller, dynamic currentCase) {
//   bool isSubmitting = false;
//   Get.dialog(
//     Dialog(
//       shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(24)),
...
//                                 setDState(() => isSubmitting = true);
//                                 final data = {
//                                   "customerId": currentCase?.globalOrderId,
//                                   "serviceId":
//                                       controller.selectedService?.serviceId,
//                                   "globalOrderId":
//                                       controller.currentCase?.globalOrderId,
//                                   "carInfoId": controller
//                                       .currentCase!.carInfoTblId,
...
//                                 } else {
//                                   await controller.addServiceToOrder(data);
//                                 }
//                                 Get.back();
//                                 if (context.mounted) {
                            ...
                            : () async {
                                ...
                                final data = {
                                  ...
                                  "globalOrderId":
                                      controller.currentCase?.globalOrderId,
                                  "carInfoId":
                                      controller.currentCase!.carInfoTblId,
                                  "resolved": controller.resolved,
                                  "notes": controller.notesController.text,
                                  "cost":
                                      double.tryParse(
